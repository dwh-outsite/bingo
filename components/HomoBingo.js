  ...
  return (
    <div className="bg-pink-400 rounded-2xl text-white text-lg overflow-hidden">
      ...
      <div className="p-4">
        ...
        Al jaren wordt de homobingo gepresenteerd door de fabuleuze <strong>ZsaZsa</strong> en haar Duitse assistent <strong>Bruno</strong>.
        Zoals gewoonlijk zijn er prijzen te winnen voor een goede bingo, maar roep pas <strong>BINGO</strong> als je het zeker weet!
        ZsaZsa en Bruno zijn heel zachtaardig maar van een <strong>valse bingo</strong> worden zij ook vals!
      </div>
    </div>
  )
}
